Console.WriteLine("1.Сложить 2 числа\l\n2. Вычесть первое из второго\l\n3. Перемножить два числа\l\n4. Разделить первое на второе\l\n5. Возвести в степень N первое число\l\n6. Найти квадратный корень из числа\l\n7. Найти 1 процент от числа\l\n8. Найти факториал из числа\l\n9. Выйти из программы\l\n");
int l = 1; 
